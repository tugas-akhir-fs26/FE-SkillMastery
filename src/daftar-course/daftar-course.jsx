    ...
    return(
        <div>
            ...
            <div className="container">
                ...
                <form class="d-flex" >
                    <input class="form-control me-2 search" type="search" placeholder="Cari Kelas.." aria-label="Search"/>
                    <button class="btn btn-success "  type="submit">Cari</button>
                </form>

            </div>

            <div className="container mt-3 head-filter">
                    <div className="col ">
                        <a href="" className="filter">Pemrograman Web</a>
                        <a href="" className="filter">Bahasa Pemrograman</a>
                        <a href="" className="filter">Desain Grafis</a>
                        <a href="" className="filter">Jaringan Komputer</a>
                    </div>
            </div>
            ...
            <div className="container">
                    <div className="row gy-3 mt-2">
                        <div className="col-sm-6 col-md-4 col-lg-3 ">
                            ...
                            <div class="card" >
                                <img src="https://www.olcbd.net/wp-content/uploads/2018/05/html-800x445.jpg" class="card-img-top" alt="img-course.jpg" />
                                <div class="card-body">
                                    <h5 class="card-title">HTML</h5>
                                    <p>{/* Nama pembuat */} Dionisius <br />
                                        <span class="card-text">4,6
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star" ></i>
                                            <i class="fas fa-star" ></i>
                                            <i class="fas fa-star" ></i>
                                            <i class="fas fa-star-half-alt" ></i>
                                            <span> {/* Jumlah pembeli course */}(54)</span><br />
            ...
            <div className="container mt-5 mb-5 faq">
                <center> <h1 >FAQ</h1>
                    ...
                    <div className="row gy-3 mt-2 justify-content-center ">
                        ...
                        <div className="col-sm-6 col-md-4 col-lg-3 align-center">
